...
public static class UiLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["KALİBRASYON MERKEZİ"]="CALIBRATION CENTER", ["Önce cihazlarını hazırla"]="Prepare your devices first", ["Her cihaz bağlantıdan sonra üç adet 5 dakikalık temel fazı tamamlar. Bu kayıtlar cihazı kullanıma açar."]="After connecting each device, complete three 5-minute base phases. These recordings prepare the device for use.",
        ["İki uyluk sensörü"]="Two thigh sensors", ["İki baldır sensörü"]="Two calf sensors", ["TEMEL FAZ  0/3"]="BASE PHASES  0/3", ["✓ KULLANIMA HAZIR"]="✓ READY TO USE", ["İSTEĞE BAĞLI · EK KAYIT"]="OPTIONAL · EXTRA RECORDING", ["Temel fazlardan sonra tek cihaz veya istediğin kombinasyonla 5 dakikalık ek kayıt yap."]="After the base phases, add a 5-minute recording with one device or any available combination.",
        ["Henüz hareket cihazı seçmedin. Sol menüden Cihazlarım'ı aç."]="No motion device is selected yet. Open My Devices from the left menu.", ["SteamVR başlık yönü ve dönüş örneklerini oyun hareketi üretmeden doğrular"]="Validates SteamVR headset direction and turn samples without generating game movement", ["Bu kombinasyonla yeni 5 dakikalık kayıt ekle"]="Add a new 5-minute recording with this combination", ["Önce bu cihazların temel kalibrasyonlarını tamamla"]="Complete base calibration for these devices first",
