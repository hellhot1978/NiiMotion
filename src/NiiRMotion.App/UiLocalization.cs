...
public static class UiLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["GÜVENLİ DURUŞ"]="SAFE STOP", ["HAREKET BAĞLANTISI KESİLDİ"]="MOTION CONNECTION LOST", ["TARANIYOR"]="SCANNING", ["SİSTEM MODU DEĞİŞTİRİLİYOR"]="CHANGING SYSTEM MODE", ["ORİJİNAL SİSTEM AKTİF"]="NATIVE SYSTEM ACTIVE", ["GEÇİŞ TAMAMLANAMADI"]="SWITCH COULD NOT BE COMPLETED",
