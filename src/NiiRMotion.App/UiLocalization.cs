...
public static class UiLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ,["OYUN İÇİ HIZ UYUMU"]="IN-GAME PACE TUNING", ["DAHA HIZLI OLMALI"]="SHOULD BE FASTER", ["HIZ DOĞRU"]="PACE IS RIGHT", ["DAHA YAVAŞ OLMALI"]="SHOULD BE SLOWER", ["SON HIZ AYARINI GERİ AL"]="UNDO LAST PACE CHANGE", ["ÖĞRENİLEN HIZI SIFIRLA"]="RESET LEARNED PACE", ["TÜM AYARLARI SIFIRLA"]="RESET ALL SETTINGS", ["Otomatik oyun ölçümü açık. Sonuç sana yavaş veya hızlı gelirse aşağıdan elle düzeltebilirsin."]="Automatic in-game measurement is active. If the result feels slow or fast, you can adjust it manually below.", ["Öğrenilmiş oyun hızı: {VALUE0}×"]="Learned game pace: {VALUE0}×"
