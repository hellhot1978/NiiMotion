...
public static class UiLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Android telefon"]="Android phone", ["Joy-Con çifti · temel kalibrasyon"]="Joy-Con pair · base calibration", ["PS Move çifti · temel kalibrasyon"]="PS Move pair · base calibration", ["Joy-Con çifti"]="Joy-Con pair", ["PS Move çifti"]="PS Move pair",
