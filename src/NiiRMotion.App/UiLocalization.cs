...
public static class UiLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["NiiMotion Canlı Durum Paneli"]="NiiMotion Live Status Panel", ["Masaüstünde profil, oyun, cihaz ve hareket hızını canlı izler. Bu pencere henüz başlığın içine yerleşen bir VR katmanı değildir."]="Monitors profile, game, devices and movement speed live on the desktop. This window is not yet an in-headset VR overlay.", ["Profil, oyun, cihaz ve hareket durumunu ayrı bir masaüstü penceresinde izle"]="Monitor profile, game, devices and movement in a separate desktop window",
