...
- Faz 9 **PARTIAL**: model sürümleme, ek kayıt geri alma, sürümlü birleşik sensör manifesti ve bütün akışları monotonic zaman damgasıyla tek zaman çizelgesinde birleştiren replay okuyucusu uygulandı. Kayıtlar artık 10 saniyelik bölümlerde akış eksikliği, uzun sensör kesintisi ve örnek yoğunluğu açısından puanlanıyor; kalite raporu kalibrasyon manifestine yazılıyor ve arayüz sorunlu zaman aralıklarını gösteriyor. Yalnız işaretlenen segmenti yeniden kaydetme/birleştirme akışı sıradaki alt adımdır.
